<template>
    <v-container>
        ...
        <div class="panel">
                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="Option">
                                <span v-for="(name, index) in val.option" :key="index">
                                    {{ name }}<br>
                                </span>
                            </td>
            ...
            <StringDetailGrid style="margin-top: 20px;" label="Option" offline v-if="selectedRow" v-model="selectedRow.option" :selectedRow="selectedRow"/>
        </div>
        <v-col>
            <v-dialog
                v-model="openDialog"
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            < label="Option" v-model="selectedRow.option" :editMode="true"/>
                            ...
                            <StringDetailGrid label="Option" offline v-model="selectedRow.option" :editMode="true"/>
